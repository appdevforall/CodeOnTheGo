...
public abstract class DrawableParserFactory {
	...
	/**
	 * Create a new drawable parser for the given file. If the given file is not an XML Document, then a no-op parser is returned which simply returns the drawable for that file. If the file is an XML document, then a suitable parser is determined by looking at the root tag of the drawable.
	 *
	 * @param context
	 *            The context. This will be used for obtaining app resources.
	 * @param file
	 *            The file to parse.
	 * @return A new {@link IDrawableParser} instance if the inputs are valid, or {@code null} if there were any issues creating the parser.
	 * @throws XmlPullParserException
	 *             Thrown by the {@link XmlPullParser#setInput(Reader)}.
	 * @throws IOException
	 *             Thrown by {@link XmlPullParser#next()}
	 */
	@Nullable
	 ...
	 *
	 * @param xmlDrawable
	 *            The XML code. This must be valid.
	 * @return A new {@link IDrawableParser} instance if the inputs are valid, or {@code null} if there were any issues creating the parser.
	 * @throws XmlPullParserException
	 *             Thrown by the {@link XmlPullParser#setInput(Reader)}.
	 * @throws IOException
