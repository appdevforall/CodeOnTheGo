...
/**
* The Gradle invocation under test: a task plus the arguments that make the init script apply
* the IDE plugins.
* @see writeInitScript
*/
val args = mutableListOf(
	task, // defaults to :app:tasks - run any task, as long as it applies the plugins
