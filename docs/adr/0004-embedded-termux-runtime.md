...
Termux is a mature, GPL-licensed Android terminal and package environment that already solves exactly this.
...
**Negative / costs**
- A large native/runtime surface and a meaningful **security consideration**: Termux executes arbitrary commands, so command-execution sinks must be handled carefully (see [SECURITY.md](../../SECURITY.md)).
