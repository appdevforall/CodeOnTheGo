...
interface PreferenceChoices {
	 ...
	 * @property tooltipTag Tag used to look up this entry's own tooltip, if it has one distinct
	 *   from the dialog's tooltip. Empty when the entry has no tooltip of its own.
	 */
	data class Entry(
