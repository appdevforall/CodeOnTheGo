...
- **Verified severable by the full host corpus matrix** - 13 apps / 48 edits, output-equivalence PASS on all of them, including `compose-kotlin`, `mixed-lang` and the real `sora-editor-lib` slice. That matrix is the regression gate for any future attempt.
