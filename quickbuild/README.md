...
| [`daemon/README.md`](daemon/README.md)                       | inside `:quickbuild:daemon` - the never-exit rule, the session lifecycle, and the two-pass compile |
