 ...
 * Restarting is safe: the relaunched proxy app boots the newest persisted generation and
 * binder catch-up reconciles the rest.
 */
...
class DeployPolicy(
	 ...
	 *
	 * @param changedClassFiles the .class paths this compile emitted, or null when the recompiled
	 *   set is unknown, which is answered conservatively by restarting whenever any
	 *   restart-sensitive component exists, since guessing "no hit" could leave a service stale.
