...
class LiveReloadExecutorImplTest {
	 ...
	 * [PayloadDeployer] bail before the decision and hides the wiring these three tests
	 * cover.
	 */
	 ...
	 * capturing it.
	 *
	 * Pins two mutations at once - deleting the [LiveReloadExecutor.markCurrentBuildUserInitiated]
	 * override (the interface default is a no-op, so it compiles and every other test
	 * stays green) and snapshotting `userInitiated()` at deploy entry.
	 */
	@Test
