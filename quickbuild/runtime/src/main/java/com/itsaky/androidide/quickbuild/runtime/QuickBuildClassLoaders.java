...
public final class QuickBuildClassLoaders {
	...
	/**
	 * Prefers the payload loader over the fallback; extracted so the choice is testable without the PayloadStore singleton.
	 *
	 * @param payloadLoader
	 *            the live payload loader, or null when no payload has been applied
	 * @param fallback
	 *            the loader to fall back to; returned verbatim, null included
