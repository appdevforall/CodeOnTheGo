...
public class QuickBuildAppComponentFactory extends AppComponentFactory {
	 ...
	 * @param className
	 *            binary name of the activity, already translated through {@link ComponentMap} by whoever built the intent
	 * @param intent
	 *            the launch intent, passed to the framework untouched
	 * @return the activity instance the framework will attach
	 * @throws InstantiationException
	 *             if the fallback instantiation fails
	 * @throws IllegalAccessException
	 *             if the fallback constructor is not accessible
	 ...
	 *
	 * A service already running keeps its class, which is why {@link ServiceTracker} makes a deploy touching service code restart the process instead of hot-swapping.
	 *
	 * @param cl
	 *            the framework's default loader, also the fallback if payload instantiation fails
	 * @param className
