 ...
 * function body, `$i$a$` for an inlined lambda argument), the inline receivers (`$this$`), and the
 * suspend state machine's own locals. These carry no meaning for someone reading their own code, so
 * the variables list hides them.
 *
