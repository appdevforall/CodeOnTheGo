...
class DiagnosticVisitor(
	...
	private fun fromDoWhileTree(
		parent: DoWhileLoopTree,
		node: BlockTree?,
	...
	private fun fromWhileTree(
		parent: WhileLoopTree,
		node: BlockTree?,
	) = if (parent.statement == node) {
		"while"
	} else {
