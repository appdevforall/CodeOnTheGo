...
public class FindHelper {
	...
	/**
	 * Find the method with name <code>methodName</code> in class <code>clasName</code> with the given parameter types.
	 *
	 * @param task
	 *            The parse task.
	 * @param className
	 ...
	 * @param methodName
	 *            The name of method in class <code>className</code>.
	 * @param erasedParameterTypes
	 *            The parameter types of the method (fully qualified class names).
