...
// Vendored from LeakCanary/Shark 2.14 (shark.internal.hppc.HPPC) so the heap-dump dominator-tree
// computation can run from this module — Shark's dominator/retained-size types are all `internal`.
// Unchanged except for the package. Original is itself a Kotlin port of com.carrotsearch.hppc.
