...
// Vendored from LeakCanary/Shark 2.14 (shark.internal.hppc.LongLongScatterMap), unchanged except for
// the package and the removal of the unused `entrySequence`/`LongLongPair` helper. See [HPPC] for why
// this is vendored.
