...
class LanguageScheme {
	...
	fun isLocalScope(capture: String): Boolean = localScopes.contains(capture)

	fun isMembersScope(capture: String): Boolean = localMembersScopes.contains(capture)

	fun isLocalDef(capture: String): Boolean = localDefs.contains(capture)

	fun isLocalDefVal(capture: String): Boolean = localDefVals.contains(capture)

	fun isLocalRef(capture: String): Boolean = localRefs.contains(capture)
}
