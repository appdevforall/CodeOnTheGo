...
struct kernel_info {
    ...
    std::variant<
            std::function<void(size_t m, size_t n, size_t k, size_t bl, const void *lhs_packed,
                               const void *rhs_packed,
                               float *dst, size_t dst_stride_row, size_t dst_stride_col,
                               float scalar_min, float scalar_max)>,
            std::function<void(size_t m, size_t n, size_t k, const void *lhs_packed,
...
struct lhs_packing_info {
    ...
    std::variant<
            std::function<size_t(size_t m_idx, size_t k, size_t bl, size_t mr, size_t kr,
                                 size_t sr)>,
    ...
    > packed_size;
    std::variant<
            std::function<void(size_t m, size_t k, size_t bl, size_t mr, size_t kr, size_t sr,
                               size_t m_idx_start, const float *lhs,
                               size_t lhs_stride, void *lhs_packed)>,
            std::function<void(size_t m, size_t k, size_t mr, size_t kr, size_t sr,
...
struct rhs_packing_info {
    ...
    std::variant<
            std::function<void(size_t num_groups, size_t n, size_t k, size_t nr, size_t kr,
                               size_t sr, size_t bl, const uint8_t *rhs,
    ...
    void
    (*to_float)(const void *packed_data, int32_t row_idx, int64_t nc, float *out, size_t nr_pack,
...
ggml_kleidiai_select_kernels(cpu_feature cpu_features, const ggml_tensor *tensor);
