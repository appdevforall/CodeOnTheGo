...
/* Values that behave roughly like in Python. */
    ...
    public:
        using CallableType = std::function<Value(const std::shared_ptr<Context> &,
                                                 ArgumentsValue &)>;
    ...
    private:
        ...
        Value(const std::shared_ptr<CallableType> &callable) : object_(
                std::make_shared<ObjectType>()), callable_(callable) {}

        /* Python-style string repr */
        static void
        dump_string(const json &primitive, std::ostringstream &out, char string_quote = '\'') {
        ...
        void
        dump(std::ostringstream &out, int indent = -1, int level = 0, bool to_json = false) const {
    ...
    public:
        ...
        static Value
        object(const std::shared_ptr<ObjectType> object = std::make_shared<ObjectType>()) {
            return Value(object);
        }
        ...
        bool contains(const Value &value) const {
            ...
            if (array_) {
                ...
                if (!value.is_hashable())
                    throw std::runtime_error("Unhashable type: " + value.dump());
    ...
    struct ArgumentsValue {
        ...
        void expectArgs(const std::string &method_name, const std::pair<size_t, size_t> &pos_count,
            ...
            if (args.size() < pos_count.first || args.size() > pos_count.second ||
                ...
                out << method_name << " must have between " << pos_count.first << " and "
                    << pos_count.second << " positional arguments and between " << kw_count.first
                    << " and " << kw_count.second << " keyword arguments";
        ...
        if (object_) {
            ...
            for (const auto &[key, value]: *object_) {
                if (key.is_string()) {
                    ...
                    throw std::runtime_error(
                            "Invalid key type for conversion to JSON: " + key.dump());
                }
            }
            if (is_callable()) {
...
namespace minja {
    ...
    public:
        Context(Value &&values, const std::shared_ptr<Context> &parent = nullptr) : values_(
                std::move(values)), parent_(parent) {
        ...
        make(Value &&values, const std::shared_ptr<Context> &parent = builtins());
    ...
    static void destructuring_assign(const std::vector<std::string> &var_names,
                                     const std::shared_ptr<Context> &context, Value &item) {
        if (var_names.size() == 1) {
    ...
    enum SpaceHandling {
        Keep, Strip, StripSpaces, StripNewline
    };
    ...
    struct TextTemplateToken : public TemplateToken {
        ...
        TextTemplateToken(const Location &loc, SpaceHandling pre, SpaceHandling post,
                          const std::string &t) : TemplateToken(Type::Text, loc, pre, post),
                                                  text(t) {}
    };
    ...
    struct ExpressionTemplateToken : public TemplateToken {
        ...
        ExpressionTemplateToken(const Location &loc, SpaceHandling pre, SpaceHandling post,
                                std::shared_ptr<Expression> &&e) : TemplateToken(Type::Expression,
                                                                                 loc, pre, post),
                                                                   expr(std::move(e)) {}
    };
    ...
    struct IfTemplateToken : public TemplateToken {
        ...
        IfTemplateToken(const Location &loc, SpaceHandling pre, SpaceHandling post,
                        std::shared_ptr<Expression> &&c) : TemplateToken(Type::If, loc, pre, post),
    ...
    struct ElifTemplateToken : public TemplateToken {
        ...
        ElifTemplateToken(const Location &loc, SpaceHandling pre, SpaceHandling post,
                          std::shared_ptr<Expression> &&c) : TemplateToken(Type::Elif, loc, pre,
                                                                           post),
                                                             condition(std::move(c)) {}
    };
    ...
    struct MacroTemplateToken : public TemplateToken {
        ...
        MacroTemplateToken(const Location &loc, SpaceHandling pre, SpaceHandling post,
                           std::shared_ptr<VariableExpr> &&n, Expression::Parameters &&p)
                : TemplateToken(Type::Macro, loc, pre, post), name(std::move(n)),
                  params(std::move(p)) {}
    };
    ...
    struct FilterTemplateToken : public TemplateToken {
        ...
        FilterTemplateToken(const Location &loc, SpaceHandling pre, SpaceHandling post,
                            std::shared_ptr<Expression> &&filter)
    ...
    struct ForTemplateToken : public TemplateToken {
        ...
        ForTemplateToken(const Location &loc, SpaceHandling pre, SpaceHandling post,
                         const std::vector<std::string> &vns, std::shared_ptr<Expression> &&iter,
                         std::shared_ptr<Expression> &&c, bool r)
                : TemplateToken(Type::For, loc, pre, post), var_names(vns),
                  iterable(std::move(iter)), condition(std::move(c)), recursive(r) {}
    };
    ...
    struct SetTemplateToken : public TemplateToken {
        ...
        SetTemplateToken(const Location &loc, SpaceHandling pre, SpaceHandling post,
                ...
                : TemplateToken(Type::Set, loc, pre, post), ns(ns), var_names(vns),
                  value(std::move(v)) {}
    };
    ...
    struct CommentTemplateToken : public TemplateToken {
        ...
        CommentTemplateToken(const Location &loc, SpaceHandling pre, SpaceHandling post,
                             const std::string &t) : TemplateToken(Type::Comment, loc, pre, post),
                                                     text(t) {}
    };
    ...
    struct LoopControlTemplateToken : public TemplateToken {
        ...
        LoopControlTemplateToken(const Location &loc, SpaceHandling pre, SpaceHandling post,
                                 LoopControlType control_type) : TemplateToken(Type::Break, loc,
                                                                               pre, post),
                                                                 control_type(control_type) {}
    };
    ...
    protected:
        virtual void
        do_render(std::ostringstream &out, const std::shared_ptr<Context> &context) const = 0;
    ...
    public:
        ...
        void
        do_render(std::ostringstream &out, const std::shared_ptr<Context> &context) const override {
    ...
    class ExpressionNode : public TemplateNode {
        std::shared_ptr<Expression> expr;
    public:
        ExpressionNode(const Location &loc, std::shared_ptr<Expression> &&e) : TemplateNode(loc),
                                                                               expr(std::move(e)) {}
    ...
    public:
        IfNode(const Location &loc,
               std::vector<std::pair<std::shared_ptr<Expression>, std::shared_ptr<TemplateNode>>> &&c)
    ...
    public:
        LoopControlNode(const Location &loc, LoopControlType control_type) : TemplateNode(loc),
                                                                             control_type_(
                                                                                     control_type) {}
    ...
    public:
        ForNode(const Location &loc, std::vector<std::string> &&var_names,
                std::shared_ptr<Expression> &&iterable,
                std::shared_ptr<Expression> &&condition, std::shared_ptr<TemplateNode> &&body,
                bool recursive, std::shared_ptr<TemplateNode> &&else_body)
                : TemplateNode(loc), var_names(var_names), iterable(std::move(iterable)),
                  condition(std::move(condition)), body(std::move(body)), recursive(recursive),
            ...
            std::function<void(Value &)> visit = [&](Value &iter) {
                ...
                if (!iter.is_null()) {
                    if (!iterable_value.is_iterable()) {
                        throw std::runtime_error(
                                "For loop iterable must be iterable: " + iterable_value.dump());
                    }
                ...
                if (filtered_items.empty()) {
                    ...
                    loop.set("cycle", Value::callable(
                            [&](const std::shared_ptr<Context> &, ArgumentsValue &args) {
                                if (args.args.empty() || !args.kwargs.empty()) {
                                    throw std::runtime_error(
                                            "cycle() expects at least 1 positional argument and no named arg");
                                }
            ...
            if (recursive) {
                loop_function = [&](const std::shared_ptr<Context> &, ArgumentsValue &args) {
                    if (args.args.size() != 1 || !args.kwargs.empty() || !args.args[0].is_array()) {
                        throw std::runtime_error(
                                "loop() expects exactly 1 positional iterable argument");
                    }
    ...
    class SetNode : public TemplateNode {
        ...
        std::shared_ptr<Expression> value;
    public:
        SetNode(const Location &loc, const std::string &ns, const std::vector<std::string> &vns,
                std::shared_ptr<Expression> &&v)
                : TemplateNode(loc), ns(ns), var_names(vns), value(std::move(v)) {}

        void
        do_render(std::ostringstream &, const std::shared_ptr<Context> &context) const override {
    ...
    public:
        IfExpr(const Location &loc, std::shared_ptr<Expression> &&c,
               std::shared_ptr<Expression> &&t, std::shared_ptr<Expression> &&e)
                : Expression(loc), condition(std::move(c)), then_expr(std::move(t)),
    ...
    public:
        DictExpr(const Location &loc,
                 std::vector<std::pair<std::shared_ptr<Expression>, std::shared_ptr<Expression>>> &&e)
                : Expression(loc), elements(std::move(e)) {}
    ...
    public:
        ...
        SliceExpr(const Location &loc, std::shared_ptr<Expression> &&s,
                  std::shared_ptr<Expression> &&e, std::shared_ptr<Expression> &&st = nullptr)
    ...
    public:
        ...
        Value do_evaluate(const std::shared_ptr<Context> &context) const override {
            ...
            if (auto slice = dynamic_cast<SliceExpr *>(index.get())) {
                ...
                int64_t start = slice->start ? wrap(slice->start->evaluate(context).get<int64_t>())
                                             : (step < 0 ? len - 1 : 0);
                int64_t end = slice->end ? wrap(slice->end->evaluate(context).get<int64_t>()) : (
                        step < 0 ? -1 : len);
                if (target_value.is_string()) {
                    ...
                    throw std::runtime_error(target_value.is_null() ? "Cannot subscript null"
                                                                    : "Subscripting only supported on arrays and strings");
                }
            } else {
                auto index_value = index->evaluate(context);
                if (target_value.is_null()) {
                    if (auto t = dynamic_cast<VariableExpr *>(base.get())) {
                        throw std::runtime_error("'" + t->get_name() + "' is " +
                                                 (context->contains(t->get_name()) ? "null"
                                                                                   : "not defined"));
                    }
                    throw std::runtime_error(
                            "Trying to access property '" + index_value.dump() + "' on null!");
                }
    ...
    public:
        enum class Op {
            Plus, Minus, LogicalNot, Expansion, ExpansionDict
        };
        std::shared_ptr<Expression> expr;
        Op op;
        ...
        Value do_evaluate(const std::shared_ptr<Context> &context) const override {
            ...
            switch (op) {
                ...
                case Op::ExpansionDict:
                    throw std::runtime_error(
                            "Expansion operator is only supported in function calls and collections");
    ...
    public:
        ...
        Value do_evaluate(const std::shared_ptr<Context> &context) const override {
            ...
            if (l.is_callable()) {
                return Value::callable([l, do_eval](const std::shared_ptr<Context> &context,
                                                    ArgumentsValue &args) {
            ...
            for (const auto &arg: this->args) {
                if (auto un_expr = std::dynamic_pointer_cast<UnaryOpExpr>(arg)) {
                    if (un_expr->op == UnaryOpExpr::Op::Expansion) {
                        ...
                        if (!dict.is_object()) {
                            throw std::runtime_error(
                                    "ExpansionDict operator only supported on objects");
                        }
    ...
    static std::string strip(const std::string &s, const std::string &chars = "", bool left = true,
                             bool right = true) {
    ...
    public:
        MethodCallExpr(const Location &loc, std::shared_ptr<Expression> &&obj,
                ...
                : Expression(loc), object(std::move(obj)), method(std::move(m)),
                  args(std::move(a)) {}
        ...
        Value do_evaluate(const std::shared_ptr<Context> &context) const override {
            ...
            if (obj.is_null()) {
                throw std::runtime_error(
                        "Trying to call method '" + method->get_name() + "' on null");
            }
            if (obj.is_array()) {
                ...
                if (method->get_name() == "items") {
                    ...
                    if (!callable.is_callable()) {
                        throw std::runtime_error(
                                "Property '" + method->get_name() + "' is not callable");
                    }
    ...
    private:
        ...
        Parser(const std::shared_ptr<std::string> &template_str, const Options &options)
        ...
        std::vector<std::string> consumeTokenGroups(const std::regex &regex,
        ...
        std::string
        consumeToken(const std::regex &regex, SpaceHandling space_handling = SpaceHandling::Strip) {
            auto start = it;
            consumeSpaces(space_handling);
            std::smatch match;
            if (std::regex_search(it, end, match, regex) && match.position() == 0) {
        ...
        std::string consumeToken(const std::string &token,
                                 SpaceHandling space_handling = SpaceHandling::Strip) {
            auto start = it;
            consumeSpaces(space_handling);
        ...
        std::shared_ptr<Expression> parseExpression(bool allow_if_expr = true) {
            ...
            return std::make_shared<IfExpr>(location, std::move(condition), std::move(left),
                                            std::move(else_expr));
        }
        ...
        std::shared_ptr<Expression> parseLogicalOr() {
            ...
            while (!consumeToken(or_tok).empty()) {
                ...
                left = std::make_shared<BinaryOpExpr>(location, std::move(left), std::move(right),
                                                      BinaryOpExpr::Op::Or);
            }
            return left;
        }
        ...
        std::shared_ptr<Expression> parseMathPow() {
            ...
            while (!consumeToken("**").empty()) {
                ...
                left = std::make_shared<BinaryOpExpr>(get_location(), std::move(left),
                                                      std::move(right), BinaryOpExpr::Op::MulMul);
            }
            return left;
        }
        ...
        call_func(const std::string &name, ArgumentsExpression &&args) const {
            return std::make_shared<CallExpr>(get_location(),
                                              std::make_shared<VariableExpr>(get_location(), name),
                                              std::move(args));
        }
        ...
        std::shared_ptr<Expression> parseExpansion() {
            ...
            return std::make_shared<UnaryOpExpr>(get_location(), std::move(expr),
                                                 op_str == "*" ? UnaryOpExpr::Op::Expansion
        ...
        std::shared_ptr<Expression> parseValueExpression() {
            ...
            while (it != end && consumeSpaces() && peekSymbols({"[", "."})) {
                if (!consumeToken("[").empty()) {
                    ...
                    value = std::make_shared<SubscriptExpr>(value->location, std::move(value),
                                                            std::move(index));
                    ...
                    if (peekSymbols({"("})) {
                        ...
                        value = std::make_shared<MethodCallExpr>(identifier->location,
                                                                 std::move(value),
                                                                 std::move(identifier),
                                                                 std::move(callParams));
                    } else {
                        auto key = std::make_shared<LiteralExpr>(identifier->location,
                                                                 Value(identifier->get_name()));
                        value = std::make_shared<SubscriptExpr>(identifier->location,
            ...
            try {
                while (it != end) {
                    ...
                    if (!(group = consumeTokenGroups(comment_tok, SpaceHandling::Keep)).empty()) {
                        ...
                        tokens.push_back(std::make_unique<CommentTemplateToken>(location, pre_space,
                                                                                post_space,
                                                                                content));
                    } else if (!(group = consumeTokenGroups(expr_open_regex,
                        ...
                        tokens.push_back(
                                std::make_unique<ExpressionTemplateToken>(location, pre_space,
                                                                          post_space,
                                                                          std::move(expr)));
                        ...
                        if (keyword == "if") {
                            ...
                            tokens.push_back(std::make_unique<IfTemplateToken>(location, pre_space,
                                                                               post_space,
                                                                               std::move(
                                                                                       condition)));
                            ...
                            auto post_space = parseBlockClose();
                            tokens.push_back(
                                    std::make_unique<ElifTemplateToken>(location, pre_space,
                                                                        post_space,
                                                                        std::move(condition)));
                        } else if (keyword == "else") {
                            auto post_space = parseBlockClose();
                            tokens.push_back(
                                    std::make_unique<ElseTemplateToken>(location, pre_space,
                                                                        post_space));
                        } else if (keyword == "endif") {
                            auto post_space = parseBlockClose();
                            tokens.push_back(
                                    std::make_unique<EndIfTemplateToken>(location, pre_space,
                                                                         post_space));
                        } else if (keyword == "for") {
                            ...
                            auto post_space = parseBlockClose();
                            tokens.push_back(std::make_unique<ForTemplateToken>(location, pre_space,
                                                                                post_space,
                                                                                std::move(varnames),
                                                                                std::move(iterable),
                                                                                std::move(
                            ...
                            auto post_space = parseBlockClose();
                            tokens.push_back(
                                    std::make_unique<EndForTemplateToken>(location, pre_space,
                                                                          post_space));
                        } else if (keyword == "generation") {
                            auto post_space = parseBlockClose();
                            tokens.push_back(
                                    std::make_unique<GenerationTemplateToken>(location, pre_space,
                                                                              post_space));
                        } else if (keyword == "endgeneration") {
                            auto post_space = parseBlockClose();
                            tokens.push_back(std::make_unique<EndGenerationTemplateToken>(location,
                                                                                          pre_space,
                                                                                          post_space));
                        } else if (keyword == "set") {
                            ...
                            auto post_space = parseBlockClose();
                            tokens.push_back(std::make_unique<SetTemplateToken>(location, pre_space,
                                                                                post_space, ns,
                                                                                var_names,
                                                                                std::move(value)));
                            ...
                            auto post_space = parseBlockClose();
                            tokens.push_back(
                                    std::make_unique<EndSetTemplateToken>(location, pre_space,
                                                                          post_space));
                            ...
                            auto post_space = parseBlockClose();
                            tokens.push_back(
                                    std::make_unique<MacroTemplateToken>(location, pre_space,
                                                                         post_space,
                                                                         std::move(macroname),
                                                                         std::move(params)));
                            ...
                            auto post_space = parseBlockClose();
                            tokens.push_back(
                                    std::make_unique<EndMacroTemplateToken>(location, pre_space,
                                                                            post_space));
                            ...
                            auto post_space = parseBlockClose();
                            tokens.push_back(
                                    std::make_unique<FilterTemplateToken>(location, pre_space,
                                                                          post_space,
                                                                          std::move(filter)));
                        } else if (keyword == "endfilter") {
                            auto post_space = parseBlockClose();
                            tokens.push_back(
                                    std::make_unique<EndFilterTemplateToken>(location, pre_space,
                                                                             post_space));
                        } else if (keyword == "break" || keyword == "continue") {
                            auto post_space = parseBlockClose();
                            tokens.push_back(
                                    std::make_unique<LoopControlTemplateToken>(location, pre_space,
                                                                               post_space,
                                                                               keyword == "break"
                        ...
                        it = text_end;
                        tokens.push_back(
                                std::make_unique<TextTemplateToken>(location, SpaceHandling::Keep,
                                                                    SpaceHandling::Keep, text));
                    } else {
                ...
                throw std::runtime_error(
                        e.what() + error_location_suffix(*template_str, std::distance(start, it)));
            }
        }
        ...
        std::shared_ptr<TemplateNode> parseTemplate(
            ...
            while (it != end) {
                ...
                if (auto if_token = dynamic_cast<IfTemplateToken *>(token.get())) {
                    ...
                    children.emplace_back(std::make_shared<ForNode>(token->location,
                                                                    std::move(for_token->var_names),
                                                                    std::move(for_token->iterable),
                                                                    std::move(for_token->condition),
                                                                    std::move(body),
                                                                    for_token->recursive,
                                                                    std::move(else_body)));
                    ...
                    children.emplace_back(std::make_shared<ExpressionNode>(token->location,
                                                                           std::move(
                                                                                   expr_token->expr)));
                } else if (auto set_token = dynamic_cast<SetTemplateToken *>(token.get())) {
                    if (set_token->value) {
                        children.emplace_back(
                                std::make_shared<SetNode>(token->location, set_token->ns,
                                                          set_token->var_names,
                        ...
                        children.emplace_back(
                                std::make_shared<SetTemplateNode>(token->location, name,
                                                                  std::move(value_template)));
                    }
                    ...
                    children.emplace_back(std::make_shared<MacroNode>(token->location,
                                                                      std::move(macro_token->name),
                                                                      std::move(
                                                                              macro_token->params),
                                                                      std::move(body)));
                    ...
                    children.emplace_back(std::make_shared<FilterNode>(token->location, std::move(
                            filter_token->filter), std::move(body)));
                    ...
                    children.emplace_back(std::make_shared<LoopControlNode>(token->location,
                                                                            ctrl_token->control_type));
    ...
    public:
        ...
        parse(const std::string &template_str, const Options &options) {
    ...
    static Value simple_function(const std::string &fn_name, const std::vector<std::string> &params,
                                 const std::function<Value(const std::shared_ptr<Context> &,
                                                           Value &args)> &fn) {
        std::map<std::string, size_t> named_positions;
        for (size_t i = 0, n = params.size(); i < n; i++) named_positions[params[i]] = i;

        return Value::callable(
                [=](const std::shared_ptr<Context> &context, ArgumentsValue &args) -> Value {
                    ...
                    for (auto &[name, value]: args.kwargs) {
                        ...
                        if (named_pos_it == named_positions.end()) {
                            throw std::runtime_error(
                                    "Unknown argument " + name + " for function " + fn_name);
                        }
    ...
    inline std::shared_ptr<Context> Context::builtins() {
        ...
        globals.set("raise_exception", simple_function("raise_exception", {"message"},
                                                       [](const std::shared_ptr<Context> &,
                                                          Value &args) -> Value {
                                                           throw std::runtime_error(
                                                                   args.at("message").get<std::string>());
                                                       }));
        globals.set("tojson", simple_function("tojson", {"value", "indent"},
                                              [](const std::shared_ptr<Context> &, Value &args) {
                                                  return Value(args.at("value").dump(
                                                          args.get<int64_t>("indent",
                                                                            -1), /* to_json= */
                                                          true));
                                              }));
        globals.set("items", simple_function("items", {"object"},
                                             [](const std::shared_ptr<Context> &, Value &args) {
                                                 ...
                                                 if (args.contains("object")) {
                                                     ...
                                                     for (auto &key: obj.keys()) {
                                                         items.push_back(
                                                                 Value::array({key, obj.at(key)}));
                                                     }
                                                 }
                                                 return items;
                                             }));
        globals.set("last", simple_function("last", {"items"},
                                            [](const std::shared_ptr<Context> &, Value &args) {
        ...
        globals.set("default",
                    Value::callable([=](const std::shared_ptr<Context> &, ArgumentsValue &args) {
                        ...
                        return boolean ? (value.to_bool() ? value : default_value) : value.is_null()
                                                                                     ? default_value
                                                                                     : value;
                    }));
        auto escape = simple_function("escape", {"text"},
                                      [](const std::shared_ptr<Context> &, Value &args) {
                                          return Value(
                                                  html_escape(args.at("text").get<std::string>()));
                                      });
        globals.set("e", escape);
        globals.set("escape", escape);
        globals.set("joiner", simple_function("joiner", {"sep"},
                                              [](const std::shared_ptr<Context> &, Value &args) {
                                                  auto sep = args.get<std::string>("sep", "");
                                                  auto first = std::make_shared<bool>(true);
                                                  return simple_function("", {}, [sep, first](
                                                          const std::shared_ptr<Context> &,
                                                          const Value &) -> Value {
                                                      if (*first) {
                                                          *first = false;
                                                  ...
                                                  return Value(html_escape(
                                                          args.at("text").get<std::string>()));
                                              }));
        globals.set("count", simple_function("count", {"items"},
                                             [](const std::shared_ptr<Context> &, Value &args) {
                                                 return Value((int64_t) args.at("items").size());
                                             }));
        globals.set("dictsort", simple_function("dictsort", {"value"},
                                                [](const std::shared_ptr<Context> &, Value &args) {
                                                    if (args.size() != 1)
                                                        throw std::runtime_error(
                                                    ...
                                                    for (auto &key: keys) {
                                                        res.push_back(
                                                                Value::array({key, value.at(key)}));
                                                    }
                                                    return res;
                                                }));
        globals.set("join", simple_function("join", {"items", "d"},
                                            [](const std::shared_ptr<Context> &, Value &args) {
                                                auto do_join = [](Value &items,
                                                    ...
                                                    return simple_function("", {"items"},
                                                                           [sep, do_join](
                                                                               ...
                                                                               if (!items.to_bool() ||
                                                                                   !items.is_array())
                                                                                   throw std::runtime_error(
                                                                                           "join expects an array for items, got: " +
                                                                                           items.dump());
                                                                               return do_join(items,
                                                                                              sep);
                                                                           });
                                                }
                                            }));
        globals.set("namespace",
                    Value::callable([=](const std::shared_ptr<Context> &, ArgumentsValue &args) {
        ...
        auto equalto = simple_function("equalto", {"expected", "actual"},
        ...
        globals.set("safe", simple_function("safe", {"value"}, [](const std::shared_ptr<Context> &,
                                                                  Value &args) -> Value {
        ...
        globals.set("int", simple_function("int", {"value"}, [](const std::shared_ptr<Context> &,
                                                                Value &args) -> Value {
            return args.at("value").to_int();
        }));
        globals.set("list", simple_function("list", {"items"}, [](const std::shared_ptr<Context> &,
                                                                  Value &args) -> Value {
            auto &items = args.at("items");
            if (!items.is_array()) throw std::runtime_error("object is not iterable");
            return items;
        }));
        globals.set("in", simple_function("in", {"item", "items"},
                                          [](const std::shared_ptr<Context> &,
                                             Value &args) -> Value {
                                              return in(args.at("item"), args.at("items"));
                                          }));
        globals.set("unique", simple_function("unique", {"items"},
                                              [](const std::shared_ptr<Context> &,
                                                 Value &args) -> Value {
                                                  auto &items = args.at("items");
                                                  if (!items.is_array())
        ...
        globals.set("map", Value::callable(
                [=](const std::shared_ptr<Context> &context, ArgumentsValue &args) {
                    auto res = Value::array();
                    if (args.args.size() == 1 &&
        ...
        globals.set("indent", simple_function("indent", {"text", "indent", "first"},
                                              [](const std::shared_ptr<Context> &, Value &args) {
                    ...
                    Value::callable([=](const std::shared_ptr<Context> &, ArgumentsValue &args) {
                        ...
                        for (auto &[name, value]: args.kwargs) {
                            ...
                            if (name == "start") {
                                ...
                                throw std::runtime_error(
                                        "Unknown argument " + name + " for function range");
                            }

                            if (param_set[i]) {
                                throw std::runtime_error(
                                        "Duplicate argument " + name + " for function range");
                            }
    ...
    Context::make(Value &&values, const std::shared_ptr<Context> &parent) {
        return std::make_shared<Context>(values.is_null() ? Value::object() : std::move(values),
                                         parent);
    }
