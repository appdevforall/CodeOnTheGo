...
using llm_graph_cb = std::function<void(const llama_ubatch &ubatch, ggml_tensor *cur,
...
using llm_graph_get_rows_fn = std::function<ggml_tensor *(ggml_context *, ggml_tensor *states,
                                                          ggml_tensor *ids)>;
