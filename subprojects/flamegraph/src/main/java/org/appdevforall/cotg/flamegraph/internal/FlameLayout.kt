...
internal fun childKey(parentKey: String, index: Int): String =
    if (parentKey.isEmpty()) index.toString() else "$parentKey/$index"

internal data class FrameRef(val key: String, val node: FlameNode<*>)
 ...
 */
internal fun resolveFocus(root: FlameNode<*>, key: String?): FrameRef {
 ...
 */
internal fun isInSubtree(framePathKey: String, selectedKey: String?): Boolean {
...
internal class FlameLayout(
    ...
    fun frameAt(depth: Int, xFraction: Float): LaidOutFrame? {
