...
public final class GradlePluginConfig {
	...
	/**
	 * Property used by the Gradle plugin to determine whether the Gradle build
	 * includes JDWP (debugging) support. This is usually set when for builds
	 * which are intended to be launched in debug mode.
	 */
