...
Generated: 2026-07-22T07:25:03.308224+00:00
...
## qr-scanner (java) -- PASS

Baseline: PASS (2751ms), classes=10

| Edit | Class | Expected route | Ops | ms | Recompiled | Status | Notes |
|---|---|---|---|---|---|---|---|
| 01-utils-percent-fix-real | method-body | code | compile | compile=555ms | 1 | PASS |  |

Output equivalence: PASS -- 10 classes match (set + CRC)
