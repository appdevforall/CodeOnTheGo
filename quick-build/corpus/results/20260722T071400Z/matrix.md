...
Generated: 2026-07-22T07:14:01.076278+00:00
...
Baseline: PASS (3370ms), classes=37

| Edit | Class | Expected route | Ops | ms | Recompiled | Status | Notes |
|---|---|---|---|---|---|---|---|
| 01-notedb-trigger-real | method-body | code | compile | compile=844ms | 2 | PASS |  |

Output equivalence: PASS -- 37 classes match (set + CRC)
