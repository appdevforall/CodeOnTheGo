...
public class MainActivity extends Activity {
	...
	public static final int ID_FAREWELL = 2003;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		TextView farewellView = new TextView(this);
		farewellView.setId(ID_FAREWELL);
		farewellView.setText(greeter.farewell(getString(R.string.greeting_name)));
		root.addView(farewellView);
