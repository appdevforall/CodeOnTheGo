...
@Composable
fun GreetingLine(text: String, taps: Int) {
	GreetingLog.record("The quick build reloaded this composable. $text [taps=$taps]")
}

@Composable
fun TapSummary(taps: Int) {
	GreetingLog.record("A freshly added composable compiled into the payload. taps=$taps")
}
