...
import org.appdevforall.cotg.corpus.medium.formatters.CurrencyFormatter
...
class DetailsActivity : Activity() {
	...
	override fun onCreate(savedInstanceState: Bundle?) {
		...
		val catalog = ProductCatalog().apply {
		...
		for (product in catalog.all()) {
			...
			val priceView = TextView(this).apply { text = currency.format(product.priceCents) }
