...
internal object ShortcutDefinitionIds {
	const val OPEN_TERMINAL = "shortcut.openTerminal"
	const val OPEN_PREFERENCES = "shortcut.openPreferences"
	const val DISMISS_MODAL = "shortcut.dismissModal"
