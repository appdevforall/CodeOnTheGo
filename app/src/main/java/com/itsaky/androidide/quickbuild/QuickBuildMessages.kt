...
fun QuickBuildMessage.resolve(context: Context): String =
	when (this) {
		...
		is QuickBuildMessage.DaemonStartFailed -> {
			context.getString(R.string.quick_build_daemon_start_failed, detail)
		}
		...
		QuickBuildMessage.DaemonRestartRetrying -> {
			context.getString(R.string.quick_build_daemon_restart_retrying)
		}
