 ...
 *
 * Runs on EVERY provision rather than behind a version marker: a marker keyed on a version constant
 * silently serves a stale bundle when content changes without a bump.
 */
