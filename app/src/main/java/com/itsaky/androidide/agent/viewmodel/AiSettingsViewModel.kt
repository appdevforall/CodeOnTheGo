...
class AiSettingsViewModel(
	...
	fun getGeminiApiKey(): String? = EncryptedPrefs.getGeminiApiKey(getApplication())
	...
	fun getGeminiApiKeySaveTimestamp(): Long = EncryptedPrefs.getGeminiApiKeySaveTimestamp(getApplication())
