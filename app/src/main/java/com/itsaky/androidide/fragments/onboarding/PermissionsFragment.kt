...
class PermissionsFragment : OnboardingMultiActionFragment(), SlidePolicy {
	...
	companion object {
		...
		@JvmStatic
		fun canDetectForegroundApps(context: Context): Boolean =
			context.isAccessibilityEnabled<ForegroundDetectionService>()
	...
	override fun createAdapter(): RecyclerView.Adapter<*> {
		return OnboardingPermissionsAdapter(
			permissions,
	...
	private fun requestPermission(permission: String) {
		when (permission) {
			...
			Manifest.permission.BIND_ACCESSIBILITY_SERVICE -> requestSettingsTogglePermission(
