...
interface IDETooltipDao {
  ...
  @Query("SELECT tooltipSummary FROM ide_tooltip_table WHERE tooltipCategory == :tooltipCategory AND " +
          "tooltipTag == :tooltipTag")
  fun getSummary(tooltipCategory : String, tooltipTag : String) : String

  @Query("SELECT tooltipDetail FROM ide_tooltip_table WHERE tooltipCategory == :tooltipCategory AND " +
          "tooltipTag == :tooltipTag")
  ...
  @Query("SELECT * FROM ide_tooltip_table WHERE tooltipCategory == :tooltipCategory AND " +
          "tooltipTag == :tooltipTag")
