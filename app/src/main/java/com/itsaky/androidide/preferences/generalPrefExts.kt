...
import com.itsaky.androidide.idetooltips.TooltipTag.PREFS_GENERAL_CONFIRMOPEN
import com.itsaky.androidide.idetooltips.TooltipTag.PREFS_GENERAL_LANGUAGE
import com.itsaky.androidide.idetooltips.TooltipTag.PREFS_GENERAL_OPENLAST
import com.itsaky.androidide.idetooltips.TooltipTag.PREFS_GENERAL_UIMODE
...
override val tooltipTag: String = PREFS_GENERAL_OPENLAST,
) : SwitchPreference() {
...
override val icon: Int? = drawable.ic_open_project,
override val tooltipTag: String = PREFS_GENERAL_CONFIRMOPEN,
) : SwitchPreference() {
