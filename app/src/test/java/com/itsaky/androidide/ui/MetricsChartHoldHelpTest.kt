...
class MetricsChartHoldHelpTest {
	...
	private fun eventAt(y: Float) = MotionEvent.obtain(0L, 0L, MotionEvent.ACTION_MOVE, 10f, y, 0)

	/** The platform's own long press, which is where the chart's hold starts counting from. */
	...
	/** The rest of the hold, after the platform's long press has already been reported. */
