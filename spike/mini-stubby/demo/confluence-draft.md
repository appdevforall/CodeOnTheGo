...
| ------------------------------------------------------------ | ------------------------------------------------------------ |
| **Keep DEX** (Son-of-Stubby, not dex-free Stubby)            | dexing measures **~0.3 s** of a ~3 s loop — eliminating it buys almost nothing for an enormous surface (intercept all of `android.jar`, ship a JVM). Bonus: real DEX in ART ⇒ standard debugger attaches. |
