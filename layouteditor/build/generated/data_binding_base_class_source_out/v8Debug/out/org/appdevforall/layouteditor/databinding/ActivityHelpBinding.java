...
public final class ActivityHelpBinding implements ViewBinding {
  ...
  private ActivityHelpBinding(@NonNull ConstraintLayout rootView, @NonNull AppBarLayout appbar,
  ...
  public static ActivityHelpBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityHelpBinding((ConstraintLayout) rootView, appbar, toolbar, webView);
    }
