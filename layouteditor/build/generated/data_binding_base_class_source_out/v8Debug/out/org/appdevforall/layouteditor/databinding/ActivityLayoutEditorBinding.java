...
public final class ActivityLayoutEditorBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityLayoutEditorBinding(@NonNull CustomDrawerLayout rootView,
  ...
  @NonNull
  public static ActivityLayoutEditorBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityLayoutEditorBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_layout_editor, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityLayoutEditorBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityLayoutEditorBinding((CustomDrawerLayout) rootView, content, deviceSize,
          divider, drawer, editorLayout, listView, paletteNavigation, paletteText, structureView,
          title, topAppBar, viewType);
    }
